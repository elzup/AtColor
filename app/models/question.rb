class Question < ApplicationRecord
  ...
  def self.setup
    ...
    Question.create(qid: 101, title: 'are you searcher?', description: 'PUT /q/101?flag=???', point: 1)
    Question.create(qid: 102, title: 'are you espr?', description: 'PUT /q/102?flag=???', point: 1)
    Question.create(qid: 103, title: 'are you jsr?', description: 'PUT /q/103?flag=???', point: 1)
    Question.create(qid: 104, title: 'are you coder?', description: 'PUT /q/104?flag=???', point: 1)
  end
